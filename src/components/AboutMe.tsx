    ...
    <section>
      <div className="about-me-text">
        <p>
          ...
          finished my frontend development education, where I gained a solid
        ...
        <p>
          ...
          or making sure the user flow feels intuitive.
        </p>
        <p>
          When I'm not coding, you’ll find me out running, decorating my
          apartment, training my dog, or cheering for my favorite Formula 1
          team, McLaren. I believe that creativity and structure can go hand in
          hand—and that’s something I bring into both my work and my hobbies.
        </p>
      </div>
    </section>
  );
